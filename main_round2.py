"""
Same as main.py but adding one more round of icp with different reference
"""
...
def run_non_linear_optimization(main_folder, axle_id):
    ...
    divide_profile = False  # Divide profile into tread and flange
    divide_tread_profile = False  # Divide tread profile into tread wall and tread surface
    ...
    if write_2dpoints:
        write_2d_points_to_file(fmaster_dict['org_points'], tmaster_dict['org_points'], axle_id=axle_id,
                                save_dir="2d_points/round2/org_axle" + str(axle_id))
    ...
    if divide_profile:
        ...
        if is_faulty:
            ...
            fmaster_dict['aligned_points'][1] = compute_icp('right_up', ['right_down'], fmaster_dict['aligned_points'][0], [False])
        else:
            fmaster_dict['aligned_points'][0] = compute_icp('left_down', ['left_up', 'right_down', 'right_up'], fmaster_dict['org_points'],
                                                            [False, False, False])
            fmaster_dict['aligned_points'].append(laser_dict.copy())
            fmaster_dict['aligned_points'][1] = compute_icp('right_down', ['left_down', 'left_up', 'right_up'], fmaster_dict['aligned_points'][0],
                                                            [False, False, False])
        ...
        if divide_tread_profile:
            ...
            twall_master_dict['aligned_points'][1] = compute_icp('right_down', ['left_down', 'left_up', 'right_up'],
                                                                 twall_master_dict['aligned_points'][0],
                                                                 [False, False, False])
            ...
            tsurf_master_dict['aligned_points'][1] = compute_icp('right_down', ['left_down', 'left_up', 'right_up'],
            ...
            tmaster_dict['aligned_points'][1] = compute_icp('right_down', ['left_down', 'left_up', 'right_up'], tmaster_dict['aligned_points'][0],
                                                            [False, False, False])
        ...
        master_dict['aligned_points'][1] = compute_icp('right_down', ['left_down', 'left_up', 'right_up'], master_dict['aligned_points'][0],
                                                       [False, False, False])
    ...
    if write_2dpoints:
        write_2d_points_to_file(fmaster_dict['aligned_points'][0], tmaster_dict['aligned_points'][0], axle_id=axle_id,
                                save_dir="2d_points/round2/aligned_axle" + str(axle_id))
...
if __name__ == '__main__':
    ...
    if is_faulty:
        ...
        main_folder = r"D:\Project_Data\Field_data\21-02-2022_13-53-04\Data\Data.json"
    else:
